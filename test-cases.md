...
### TC-8: Filtrado por campo OBSERVACION (de AC-1.4)

**Datos:** CSV de ingresantes que contiene registros con diferentes valores en el campo `OBSERVACION` (ej. "ALCANZO VACANTE", "NO INGRESÓ").
