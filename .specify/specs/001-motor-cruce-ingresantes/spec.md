...
- El filtro de OBSERVACION (AC-004) se aplica **después** de la normalización del campo, no sobre el valor crudo. _(NC-1 — Resuelto. Ver Open Questions.)_
...
| --------------------------------------------------------------------------------------------------------------- | :---------: | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| Papalini, E. (2026). _Non-Deterministic Spec-Driven Development — Enterprise Edition_. Independently published. | 2026-06-24  | Cap. 2 (Four Phases / Four Gates), Cap. 11-12 (Enterprise SDD Pipeline), App. C Template 2 (spec.md) | Framework de referencia para la estructura del presente spec                             |
